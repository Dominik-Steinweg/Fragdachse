...
- **Encounter & XP:** Encounter anlegen, kopieren, umordnen und löschen; Startbedingungen und Gruppen getrennt bearbeiten. Die Liste zeigt ausschließlich enthaltene Gegnerarten. Neue Arten über die Auswahl hinzufügen; „Gegnerart löschen“ entfernt alle zugehörigen Gruppen in einem Undo-Schritt. `0` in einer einzelnen Gegner-Mengenzeile entfernt die Gruppe. Mehrfachgruppen werden aufgeklappt und behalten eigene Verzögerungen, Spawnfenster und Gebiete. Referenzierte Encounter/Wände können nicht unbemerkt entfernt werden.
