...
const EXPLOSION_ASSETS = {
  sfx_explosion_he:             './assets/sounds/sfx_explosion_he.wav',
  sfx_explosion_smoke:          './assets/sounds/sfx_explosion_smoke.wav',
  sfx_explosion_holy:           './assets/sounds/sfx_explosion_holy.wav',
  sfx_explosion_rocket:         './assets/sounds/sfx_explosion_rocket.wav',
...
const LOADOUT_ASSETS = {
  ...
  sfx_nuke_countdown:       './assets/sounds/sfx_nuke_countdown.wav',
  sfx_nuke_explosion:       './assets/sounds/sfx_nuke_explosion.wav',
  sfx_airstrike_countdown:  './assets/sounds/sfx_airstrike_countdown.wav',
  sfx_airstrike_explosion:  './assets/sounds/sfx_airstrike_explosion.wav',
...
const GENERAL_ASSETS = {
  sfx_player_move:     './assets/sounds/sfx_player_move.wav',
  sfx_dash:            './assets/sounds/sfx_dash.wav',
  sfx_burrowed:        './assets/sounds/sfx_burrowed.wav',
  ...
  sfx_player_spawn:    './assets/sounds/sfx_player_spawn.wav',
  sfx_ctb_score:       './assets/sounds/sfx_ctb_score.wav',
  sfx_countdown_3:     './assets/sounds/sfx_countdown_3.wav',
  sfx_countdown_2:     './assets/sounds/sfx_countdown_2.wav',
  sfx_countdown_1:     './assets/sounds/sfx_countdown_1.wav',
  sfx_countdown_go:    './assets/sounds/sfx_countdown_go.wav',
  sfx_train_move:      './assets/sounds/sfx_train_move.wav',
