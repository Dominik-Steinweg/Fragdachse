...
export const SOUND_MUSIC_VOLUME = 0.35;
...
export const BLOOD_HIT_VFX = {
  /** Sichttest: Zum Wiedereinschalten einzeln auf true setzen. */
  bloodCoreEnabled: true,
  bloodStreakEnabled: true,
  bloodDropletEnabled: true,
  bloodMicroDropletEnabled: true,
  /** Verstaerkt beide Tropfen-Layer oberhalb der Tiny-Schadensstufe. */
  dropletBoost: {
    count: 2.5,
    scale: 2,
    duration: 2,
  ...
  /** Kompaktes Trefferblut: kurze zusammenhaengende Spritzer statt wachsendem Bodenfleck. */
  coreSplash: {
    count: 7,
    tinyCount: 2,
    killshotExtraCount: 2,
    killshotScale: 1.15,
    scaleMin: 0.28,
    scaleMax: 0.48,
    spawnRadiusPx: 3,
  ...
  stainDelayMs: 250,
  bands: {
    /** Kleinstschaden bleibt dezent; normale Waffentreffer bekommen deutlich mehr Praesenz. */
    tiny: {
      maxDamage: 3,
      spreadDeg: 18,
      streakCountMin: 3,
...
export function getArenaMetricsProfile(
  ...
  // Diese reine Profilaufloesung dient dem prozeduralen World-Pfad und dem
  // Kompatibilitaetsspiegel. Eine authored World bringt ihre Metrik aus ihrer Definition mit;
  // der mutable Spiegel wird daraus nur abgeleitet und ist keine zweite Geometriequelle.
...
// ---- Ressourcen ----
export const ADRENALINE_MAX            = 400;
export const ADRENALINE_REGEN_MAX      = 100;
export const ADRENALINE_START          = 30;
export const ADRENALINE_REGEN_PER_SEC  = 40;    // passiv, Host
...
export const FIREBALL_FLAME_BURN_DAMAGE_FACTOR = 4;
