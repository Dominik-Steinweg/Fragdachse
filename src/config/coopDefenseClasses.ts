...
export const COOP_DEFENSE_CLASS_DEFINITIONS: Readonly<Record<CoopDefenseClassId, CoopDefenseClassDefinition>> =
  Object.freeze({
    ...
    inspector_gadachs: {
      ...
      role: 'Ingenieur',
      description: 'Baut dauerhafte Konstruktionen im Rahmen einer festen Baukapazitaet.',
      tooltipLines: [
        'Loadout: Waffe 1, Ueberladungskern auf RMB, mehrere Utility-Slots, Ultimate.',
        'Konstrukte belegen Baukapazitaet (100 Punkte) statt Adrenalin.',
        'R haelt das Utility-Rad offen, E setzt die Auswahl ein.',
        'Staerke: stellt bleibende Verteidigung auf und ueberlaedt sie im Ernstfall.',
      ],
      outgoingDamageMultiplier: 1,
      criticalChance: 0,
      criticalDamageMultiplier: 1,
