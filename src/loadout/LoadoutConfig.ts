...
export const WEAPON_CONFIGS = {
  ...
  TESLA_DOME: {
    ...
    fire: {
      ...
      requireLineOfSight:       true,
      targetTypes:              ['players', 'enemies', 'train', 'turrets'] satisfies readonly TeslaDomeTargetType[],
