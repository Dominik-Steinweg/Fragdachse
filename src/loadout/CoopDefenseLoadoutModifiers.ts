...
export const CONFIG_STAT_DESCRIPTORS: Readonly<Record<string, ConfigStatDescriptor>> = Object.freeze({
  ...
  'weapon.PLASMA_BURNER.range': { kind: 'weapon', itemId: 'PLASMA_BURNER', targets: [{ path: ["range"], formula: 'add' }] },
  'weapon.PLASMA_BURNER.plasmaBurner.chargesLevel': { kind: 'weapon', itemId: 'PLASMA_BURNER', targets: [{ path: ["plasmaBurner","chargesLevel"], formula: 'add' }] },
  'weapon.PLASMA_BURNER.plasmaBurner.targetLockLevel': { kind: 'weapon', itemId: 'PLASMA_BURNER', targets: [{ path: ["plasmaBurner","targetLockLevel"], formula: 'add' }] },
  'weapon.PLASMA_BURNER.plasmaBurner.overloadEnabled': { kind: 'weapon', itemId: 'PLASMA_BURNER', targets: [{ path: ["plasmaBurner","overloadEnabled"], formula: 'add' }] },
  'weapon.PLASMA_BURNER.plasmaBurner.capacitorLevel': { kind: 'weapon', itemId: 'PLASMA_BURNER', targets: [{ path: ["plasmaBurner","capacitorLevel"], formula: 'add' }] },
  'weapon.PLASMA_BURNER.plasmaBurner.retentionLevel': { kind: 'weapon', itemId: 'PLASMA_BURNER', targets: [{ path: ["plasmaBurner","retentionLevel"], formula: 'add' }] },
  'weapon.PLASMA_BURNER.plasmaBurner.chainEnabled': { kind: 'weapon', itemId: 'PLASMA_BURNER', targets: [{ path: ["plasmaBurner","chainEnabled"], formula: 'add' }] },
  'weapon.PLASMA_BURNER.plasmaBurner.cascadeLevel': { kind: 'weapon', itemId: 'PLASMA_BURNER', targets: [{ path: ["plasmaBurner","cascadeLevel"], formula: 'add' }] },
  'weapon.PLASMA_BURNER.plasmaBurner.couplingLevel': { kind: 'weapon', itemId: 'PLASMA_BURNER', targets: [{ path: ["plasmaBurner","couplingLevel"], formula: 'add' }] },
