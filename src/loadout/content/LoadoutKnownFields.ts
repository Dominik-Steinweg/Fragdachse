...
export const LOADOUT_ALLOWED_KEYS_BY_PATH: Readonly<Record<string, ReadonlySet<string>>> = {
  "utility.plague": new Set(["damagePerTick","tickIntervalMs","directDurationMs","firstGenerationDurationMs","secondGenerationDurationMs","spreadIntervalMs","searchRadius","contactGap","lifeLeechFraction","pandemicEnabled","vulnerabilityEnabled","deathChunkCount","combatMoveSpeedBonus","combatDamageReduction"]),
