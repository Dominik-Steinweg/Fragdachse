...
export const HELD_ITEM_SPRITES: Readonly<Record<string, HeldItemSpriteSpec>> = Object.freeze({
  GLOCK: sprite('GLOCK', 2.5, 8.5, 2.5, 0),
  ASMD_PRIM: sprite('ASMD_PRIM', 4.5, 10.5),
  PLASMA: sprite('PLASMA', 3.5, 11.5),
  HYDRA: sprite('HYDRA', 4.5, 13.5),
  XBOW: sprite('XBOW', 4.5, 12.5),
  LAUBBLAESER: sprite('LAUBBLAESER', 3.5, 12.5),
  ...
  SHOTGUN: sprite('SHOTGUN', 4.5, 16.5, 4.5, 0),
  ASMD_SEC: sprite('ASMD_SEC', 4.5, 14.5),
  ROCKET_LAUNCHER: sprite('ROCKET_LAUNCHER', 5.5, 19.5, 5.5, 0),
  MINI_ROCKET_LAUNCHER: sprite('MINI_ROCKET_LAUNCHER', 3.5, 11.5),
  AWP: sprite('AWP', 3.5, 27.5, 3.5, 0),
  FLAMETHROWER: sprite('FLAMETHROWER', 4.5, 13.5),
  NEGEV: sprite('NEGEV', 5.5, 20.5, 5.5, 0),
