...
export const SHADOW_CASTERS = {
  rock: {
    ...
    inflatePx: 4,
    shape: 'cell',
    footprintWidthPx: CELL_SIZE + 8,
    footprintHeightPx: CELL_SIZE + 8,
  },
  trunk: {
    enabled: true,
  ...
  player: {
    ...
    inflatePx: 1,
    shape: 'ellipse',
    footprintWidthPx: PLAYER_SIZE * 0.92,
  ...
  trainLoco: {
    ...
    inflatePx: 3,
    shape: 'capsule',
    footprintWidthPx: TRAIN.VISUAL_WIDTH * 0.88,
    footprintHeightPx: TRAIN.LOCO_HEIGHT * 0.9,
  },
  trainWagon: {
    enabled: true,
    layerDepth: DEPTH.TRAIN - 0.08,
    ...
    inflatePx: 2,
    shape: 'capsule',
    footprintWidthPx: TRAIN.VISUAL_WIDTH * 0.84,
    footprintHeightPx: TRAIN.WAGON_HEIGHT * 0.88,
  },
  projectileRocket: {
    enabled: true,
