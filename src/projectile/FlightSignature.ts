...
export const FLIGHT_SIGNATURE_PROFILES = {
  ...
  light: {
    coreIntensity: 0.94, coreWidth: 2.4, coreLength: 300,
    wakeIntensity: 0.52, wakePersistence: 420, wakeSpread: 4.5,
  ...
  automatic: {
    coreIntensity: 0.98, coreWidth: 2.9, coreLength: 400,
    wakeIntensity: 0.64, wakePersistence: 500, wakeSpread: 6.5,
    heatContrast: 0.86, wakeTurbulence: 0.22, moteAmount: 0.015, speedResponse: 0.6,
  },
  heavy: {
    coreIntensity: 1, coreWidth: 3.6, coreLength: 440,
    wakeIntensity: 0.72, wakePersistence: 500, wakeSpread: 8,
  ...
  sustained: {
    coreIntensity: 0.94, coreWidth: 2.7, coreLength: 360,
    wakeIntensity: 0.56, wakePersistence: 440, wakeSpread: 5.2,
    heatContrast: 0.86, wakeTurbulence: 0.28, moteAmount: 0.012, speedResponse: 0.55,
  },
  scatter: {
    coreIntensity: 0.96, coreWidth: 3.8, coreLength: 210,
    wakeIntensity: 0.54, wakePersistence: 300, wakeSpread: 3.2,
    heatContrast: 0.8, wakeTurbulence: 0.08, moteAmount: 0.008, speedResponse: 0.4,
  },
  sniper: {
    coreIntensity: 1, coreWidth: 2.8, coreLength: 500,
    wakeIntensity: 0.68, wakePersistence: 500, wakeSpread: 6,
    heatContrast: 0.95, wakeTurbulence: 0.14, moteAmount: 0.025, speedResponse: 0.85,
  },
  highEnergy: {
    coreIntensity: 1, coreWidth: 4.3, coreLength: 480,
    wakeIntensity: 0.78, wakePersistence: 500, wakeSpread: 9.5,
