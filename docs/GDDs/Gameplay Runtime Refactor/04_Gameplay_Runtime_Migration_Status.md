...
Aktuell keine offenen Implementierungsübergänge innerhalb der abgeschlossenen Phasen. 2A/2B/3A/3B/4A/4B/4C/5/6A/6B/7A/7B/7C/8A/8B/8C/9/10A bleiben abgeschlossen, und die nächste offene fachliche Transition ist 10B.
...
**Teilphase 10A umsetzen – LoadoutManager auf echten Loadout-Owner reduzieren.**

Dabei:

1. Verbliebene Action-/Resource-Commit-/Behavior-/Execution-Orchestrierung aus `LoadoutManager` entfernen.
2. Ausschließlich Equipment, Config-Auflösung, item-lokale Readiness/Spread, Temporary-Utility-Verfügbarkeit und passende Read-Views dort belassen.
3. Bestehende kleine Player-Behavior- und Execution-Grenzen weiterverwenden; keinen Projectile-/Combat-Full-Refactor vorziehen.
4. Referenz: Phase-10A-Abschnitt in `03`.
5. Gate: Loadout-Selection/Config/Readiness-, Temporary-Utility-, Aim/Spread- und Source-Ratchet-Tests sowie TypeScript-Check.
