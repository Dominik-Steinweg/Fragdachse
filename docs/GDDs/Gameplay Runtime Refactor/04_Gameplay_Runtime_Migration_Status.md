...
Aktuell keine offenen Implementierungsübergänge innerhalb der abgeschlossenen Phasen. 2A/2B/3A/3B/4A/4B/4C/5/6A/6B/7A/7B/7C/8A/8B/8C bleiben abgeschlossen, und die nächste offene fachliche Transition ist 9.
...
**Teilphase 9 umsetzen – Tesla Dome / Energy Shield Behavior.**

Dabei:

1. Slot-Claim-/Switch-Semantik für Tesla Dome und Energy Shield aus dem Loadout herauslösen.
2. Start/Refresh, Resource-Gate und Stop/Deactivate der bestehenden Sustained-Systeme über kleine Capabilities binden.
3. Autonomous-vs-Channel-Semantik sowie Player-Remove, Loadout-Switch und World-Teardown erhalten.
4. Referenz: Phase-9-Abschnitt in `03`.
5. Gate: Tesla-Dome-, Energy-Shield-, Slot-Switch-/Channel-, Lifecycle- und TypeScript-Checks.
