...
| Feld | Aktueller Wert |
|---|---|
| Gesamtstatus | Block B gestoppt; R2 Review 6 mit zwei Blockern |
...
| Nächster Arbeitsschritt | Manuelle Prüfung/Freigabe der R2-Blocker; P7 nicht beginnen |
...
| Arbeitsbranch / lokaler Checkout-HEAD | `codex/combat-runtime-refactor` @ `4fe33c9e` |
...
| Aktueller Reparaturzähler | Nutzer-Ausnahme Fix 5 genutzt; Review 6 fehlgeschlagen |
...
| R2 | B | 🟧 | Review 6: zwei Lifetime-Blocker; Nutzerstopp |
...
| R2-Blocker | Vorab gesammelter Burn-Beitrag überlebt endgültigen Player-Source-Detach | Manuelle Prüfung |
| R2-Blocker | Item-Reaction-Cleanup löscht Status eines gleichnamigen Enemy-Nachfolgers | Manuelle Prüfung |
...
**R2 Review 6:** Basisgates grün; 25/25 Death-Spawn-Zusatzfälle bestanden. Zusatzrepros bestätigen stale Burn-Arbeit nach Source-Detach und nachgelagerten ID-basierten Item-Status-Cleanup.

| Review | Ergebnis | Geprüfter Code-HEAD | Offene Blocking-Findings |
|---|---|---|---|
| R1 | Bestanden | `ee5742b4` | Keine |
| R2 Review 6 | Nicht bestanden | `4fe33c9e` | Burn-Detach-Batch; Item-Cleanup am Enemy-Nachfolger |
