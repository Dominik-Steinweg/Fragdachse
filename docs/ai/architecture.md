...
2. Ziel, Timer, Gegner, Mission, Round-Events oder Aktivitätsprogress gehören in Activity-Definition und Activity-Systeme.
3. Admission, Beobachten und World-Eingaben gehören in WorldParticipation, Capabilities und NetworkBridge.
4. Sichtbarkeit, Kamera, FX und Overlay gehören in Presentation, Renderer oder Effects.
5. Ein neues Netzwerkobjekt braucht eine explizite Identität und, für World-Daten, worldRevision-Bindung.
