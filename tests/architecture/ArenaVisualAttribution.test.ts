...
const DIRECT_VECTOR_FACTORY_EXCEPTIONS: Readonly<Record<string, Readonly<Record<string, string>>>> = {
  ...
  'src/entities/BaseEntity.ts:147': { rectangle: 'Invisible Arcade physics hitbox; it never renders.' },
  'src/effects/ShadowSystem.ts:1092': { graphics: 'Invisible RenderTexture bake helper; only the baked texture is rendered.' },
